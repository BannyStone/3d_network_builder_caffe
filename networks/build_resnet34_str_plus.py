...
from blocks import PreActWiderDecoupBlock, PreActWiderDecoupSgpAttenBlock, PreActWiderDecoupSgpAttenStrongestBlock, PreActWiderDecoupSgpAttenMixBlock
...
def write_prototxt(is_train, output_folder, \
    ...
    for stage in range(4):
        for block in range(blocks[stage]):
            ...
            # if stage < 3:
                # first_block = True if stage == 0 and block == 0 else False
            if stage < 3:
